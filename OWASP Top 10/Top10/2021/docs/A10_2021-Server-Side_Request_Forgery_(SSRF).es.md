# A10:2021 – Falsificación de Solicitudes del Lado del Servidor (SSRF)    ![icon](OWASP%20Top%2010/Top10/2021/docs/assets/TOP_10_Icons_Final_SSRF.png){: style="height:80px;width:80px" align="right"}
