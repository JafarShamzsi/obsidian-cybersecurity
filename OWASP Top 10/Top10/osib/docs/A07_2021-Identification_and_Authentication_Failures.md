...
-   Uses plain text, encrypted, or weakly hashed passwords data stores (see
    [A02:2021-Cryptographic Failures](OWASP%20Top%2010/Top10/osib/docs/A02_2021-Cryptographic_Failures.md)).
